...
# 参考 compare_windows_global.py 的颜色
STYLE_GLOBAL = {
    ...
    for name, fname in FILES.items():
        ...
        try:
            ...
            if 'err_online_pos' in raw:
                ...
                v_arr = raw['err_online_vel'] if 'err_online_vel' in raw else np.zeros_like(p_arr)
            elif 'err_pos' in raw:
                p_arr = raw['err_pos']
                v_arr = raw['err_vel']
