...
def auto_find_and_plot_best_segment():
    ...
    for name, fname in FILES.items():
        ...
        try:
            ...
            if 'err_online_pos' in data:
                ...
                data_map_vel[name] = data['err_online_vel'] if 'err_online_vel' in data else np.zeros_like(data['err_nn_pos'])
            else:
    ...
    for i in range(START_SEARCH, END_SEARCH):
        ...
        # 核心条件: 90 < 180 < 45
        if (rmses['Win 90'] < rmses['Win 180'] and
                rmses['Win 180'] < rmses['Win 45']):
