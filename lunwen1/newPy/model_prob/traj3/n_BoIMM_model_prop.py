...
# 1. 配置参数
# ==========================================
CSV_FILE_PATH = r'../../../../dataSet/test_data/f16_complex_data_razor.csv'
DT = 1 / 30  # 30Hz 采样率
...
def main():
    ...
    imm_098 = IMMFilterEnhanced(create_trans_matrix(0.9999996), initial_state, initial_cov, r_cov=r_cov)
